...
function updateModalWithLaptopDetails(laptop) {
  ...
  paramsOfLaptop[0].innerText = `Adı: ${laptop.ad}`;
  paramsOfLaptop[1].innerText = `Təsviri: ${laptop.description}`;
  paramsOfLaptop[2].innerText = `Qiyməti:: ${laptop.cost}`;
  paramsOfLaptop[3].innerText = `Telefon: ${JSON.parse(phoneNum).phone}`;
  paramsOfLaptop[4].innerText = `Yeni: ${laptop.usage}`;
  paramsOfLaptop[5].innerText = `RAM: ${laptop.emeliyaddash}`;
  paramsOfLaptop[6].innerText = `CPU: ${laptop.cpu}`;
  paramsOfLaptop[7].innerText = `Daxili yaddaş: ${laptop.daimi}`;
  paramsOfLaptop[8].innerText = `Daxili yaddaşın növü: ${laptop.romcategory}`;
  paramsOfLaptop[9].innerText = `Əməliyyat Sistemi: ${laptop.os}`;
  paramsOfLaptop[10].innerText = `VideoKarta: ${laptop.ram}`;
