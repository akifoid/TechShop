...
inputs1.forEach(item => {
    item.addEventListener('input', () => {
            if(item.value != "" && item.value.length >= 2){
                ...
                item.nextElementSibling.innerText = 'Doğrudur'
                ...
                item.nextElementSibling.innerText = 'Buranı boş qoymayın. Minimum 2 - maksimum 30 simvol ola bilər'
...
input2.addEventListener('input', () => {
    if(input2.checkValidity() == true && input2.value != ""){
        ...
        input2.nextElementSibling.innerHTML = 'Doğrudur'
        ...
        input2.nextElementSibling.innerHTML = 'Nömrəniz düzgün formatda yazılmayıb. Bu formatda yazılmalıdır (000-000-0000)'
...
enterbtn.addEventListener('click', () => {
    if(flag1 == true && flag2 == true){
        ...
        alert("Qeydiyyatda gözlənilməz xəta baş verdi!")
    }
})